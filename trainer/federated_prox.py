...
class FederatedProxImageNet(BaseTrainer):
    """
    ...
    def run(self):
        ...
        for federated_round in range(self.start_round, self.total_round + 1):
            ...
            # for client_id in self.selected_clients:
                ...
                if self.local_model_local_test:
                    local_obj, local_top1, local_top5 = self.evaluation(model,
                                                                        self.client_test_loader[client_id],
                                                                        self.device)
            ...
            if self.local_model_global_test:
                global_obj, global_top1, global_top5 = _all_reduce(total_global_obj, total_global_top1,
                                                                   total_global_top5)
